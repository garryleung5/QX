...
^http[s]?:\/\/((app|api)\.(\w{2,15})?\.(com|cn)).*player\.(v3|v2|v1).Play(URL|View).*$ url script-request-header https://github.com/garryleung5/QX/raw/main/Rewrite/UnlockVip/BilibiliProCrack.js
